...
# Form implementation generated from reading ui file 'ttMainWindowTest.ui'
#
# Created: Wed Feb 29 15:30:37 2012
...
class Ui_ttMainWindow(object):
    def setupUi(self, ttMainWindow):
        ...
        self.menubar = QtGui.QMenuBar(ttMainWindow)
        ...
        self.menuPuzzle = QtGui.QMenu(self.menubar)
        self.menuPuzzle.setObjectName("menuPuzzle")
        self.menuHelp = QtGui.QMenu(self.menubar)
        self.menuHelp.setObjectName("menuHelp")
        ttMainWindow.setMenuBar(self.menubar)
        ...
        self.menuPuzzle.addAction(self.actionNew_Layer)
        self.menuPuzzle.addAction(self.actionSymmetry)
        self.menuPuzzle.addAction(self.actionNew_Vector)
        self.menuHelp.addAction(self.actionTwistyTools_Help)
        self.menuHelp.addAction(self.actionAbout)
        self.menubar.addAction(self.menuFile.menuAction())
        self.menubar.addAction(self.menuEdit.menuAction())
        self.menubar.addAction(self.menuPuzzle.menuAction())
    ...
    def retranslateUi(self, ttMainWindow):
        ...
        self.menuFile.setTitle(QtGui.QApplication.translate("ttMainWindow", "File", None, QtGui.QApplication.UnicodeUTF8))
        self.menuEdit.setTitle(QtGui.QApplication.translate("ttMainWindow", "Edit", None, QtGui.QApplication.UnicodeUTF8))
        self.menuPuzzle.setTitle(QtGui.QApplication.translate("ttMainWindow", "Puzzle", None, QtGui.QApplication.UnicodeUTF8))
        self.menuHelp.setTitle(QtGui.QApplication.translate("ttMainWindow", "Help", None, QtGui.QApplication.UnicodeUTF8))
